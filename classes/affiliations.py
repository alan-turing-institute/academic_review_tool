...
def generate_affiliation_id(affiliation_data: pd.Series):
        ...
        affiliation_id = affiliation_id.replace('F:-', 'F:').replace('--', '-').replace('F:-', 'F:').strip('-')
...
class Affiliation:
    ...
    """
    This is a Affiliation object. It is designed to store data about an individual affiliation and their publications.
    ...
    def update_id(self):
        ...
        current_id = self.details.loc[0, 'affiliation_id']
